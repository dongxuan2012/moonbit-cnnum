...
function _M0DTPC16result6ResultGbRPB7FailureE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGbRPB7FailureE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGbRPB7FailureE2Ok(param0) {
  this._0 = param0;
}
...
function _M0MPC15array5Array3mapGRPB4JsonsEHRPB7Failure(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0MPC15array5Array3mapGssEHRPC15error5Error(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0IP212dongxuan20125cnnum11NumberErrorPC15debug5Debug8to__repr(_x_281) {
  ...
  _L: {
    ...
    const _$42$arg_282 = _Invalid._0;
    _arg_282 = _$42$arg_282;
    break _L;
  }
...
function _M0FP212dongxuan20125cnnum5group(n, financial) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      const _tmp$2 = _M0MPC15array5Array2atGiE(powers, i);
      if (_tmp$2 === 0) {
        $panic();
      }
      if (10 === 0) {
      ...
      const d = (n / _tmp$2 | 0) % 10 | 0;
      if (d === 0) {
        if (_M0IP016_24default__implPB2Eq10not__equalGsE(result.val, "")) {
          zero.val = true;
        }
      } else {
        if (zero.val) {
          result.val = `${result.val}零`;
          zero.val = false;
        }
        result.val = `${result.val}${_M0MPC15array5Array2atGRPB4JsonE(names, d)}${_M0MPC15array5Array2atGRPB4JsonE(units, 3 - i | 0)}`;
      }
      _tmp = i + 1 | 0;
      continue;
    } else {
...
function _M0FP212dongxuan20125cnnum23format__integer_2einner(n, financial) {
  ...
  const skipped = new _M0TPB8MutLocalGbE(false);
  const _bind = 0;
  const _bind$2 = 4;
  let _tmp = _bind;
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      const _tmp$2 = _M0MPC15array5Array2atGRPB4JsonE(powers, i);
      if (_tmp$2 === 0n) {
        $panic();
      }
      if (10000n === 0n) {
      ...
      const part = Number(BigInt.asIntN(32, BigInt.asUintN(64, BigInt.asIntN(64, BigInt.asUintN(64, BigInt.asIntN(64, value) / BigInt.asIntN(64, _tmp$2))) % BigInt.asIntN(64, 10000n)))) | 0;
      if (part === 0) {
        if (_M0IP016_24default__implPB2Eq10not__equalGsE(out.val, "")) {
          skipped.val = true;
        }
      } else {
  ...
  let _tmp$2;
  if (!financial) {
    const _tmp$3 = out.val;
    const _bind$3 = "一十";
    _tmp$2 = _M0MPC16string6String11has__prefix(_tmp$3, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length));
  } else {
    _tmp$2 = false;
  }
  if (_tmp$2) {
...
function _M0FP212dongxuan20125cnnum13format__money(cents) {
  ...
  const out = new _M0TPB8MutLocalGsE(`${_tmp}${_tmp$2}元`);
  if (10n === 0n) {
    $panic();
  }
  if (10n === 0n) {
  ...
  const jiao = Number(BigInt.asIntN(32, BigInt.asUintN(64, BigInt.asIntN(64, BigInt.asUintN(64, BigInt.asIntN(64, n) / BigInt.asIntN(64, 10n))) % BigInt.asIntN(64, 10n)))) | 0;
  if (10n === 0n) {
    $panic();
  }
  ...
  if (jiao > 0) {
    ...
    if (BigInt.asIntN(64, n) >= BigInt.asIntN(64, 100n)) {
      out.val = `${out.val}零`;
    }
  }
  if (fen > 0) {
    ...
    while (true) {
      if (i.val < cs.length) {
        ...
        while (true) {
          const n = _tmp;
          if (n < _bind$5) {
            if (_M0MPC15array5Array2atGRPB4JsonE(names, n) === _M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(cs, i.val))) {
              value.val = n;
            }
            _tmp = n + 1 | 0;
            continue;
...
function _M0FP212dongxuan20125cnnum8text__at(text, start, needle) {
  ...
  const _bind = 0;
  const _bind$2 = needle.length;
  let _tmp = _bind;
  while (true) {
    const j = _tmp;
    if (j < _bind$2) {
      const _tmp$2 = start + j | 0;
      if (_M0IPC16uint166UInt16PB2Eq10not__equal(_tmp$2 >>> 0 < text.length ? text.charCodeAt(_tmp$2) : $oob(), j >>> 0 < needle.length ? needle.charCodeAt(j) : $oob())) {
        return false;
      }
      _tmp = j + 1 | 0;
      continue;
...
function _M0FP212dongxuan20125cnnum11number__end(text, start, chinese) {
  ...
  while (true) {
    if (i.val < text.length) {
      ...
      if (c === 46 || (c === 65294 || chinese && (c === 28857 || c === 40670))) {
        if (point.val || i.val === start) {
          break;
        }
        point.val = true;
        i.val = i.val + 1 | 0;
      ...
      if (chinese) {
        ...
        _tmp$2 = _M0MPC16string6String8contains("零〇一二两兩三四五六七八九十百千万亿壹贰貳叁參肆伍陆陸柒捌玖拾佰仟萬億", new _M0TPC16string10StringView(_bind, 0, _bind.length));
      } else {
        _tmp$2 = false;
      }
      if (_tmp$2) {
  ...
  while (true) {
    ...
    if (i.val > start) {
      ...
      if ((_tmp$3 >>> 0 < text.length ? text.charCodeAt(_tmp$3) : $oob()) === 46) {
        _tmp$2 = true;
      } else {
        const _tmp$4 = i.val - 1 | 0;
        _tmp$2 = (_tmp$4 >>> 0 < text.length ? text.charCodeAt(_tmp$4) : $oob()) === 65294;
      }
      _tmp = _tmp$2;
    } else {
      _tmp = false;
  ...
  while (true) {
    ...
    if (d < 0) {
      ...
      if (d > 9) {
        ...
        _tmp$2 = BigInt.asIntN(64, _tmp$3) > BigInt.asIntN(64, BigInt.asUintN(64, BigInt.asIntN(64, BigInt.asUintN(64, 9999999999999999n - BigInt.asUintN(64, BigInt(d)))) / BigInt.asIntN(64, 10n)));
      }
      _tmp = _tmp$2;
    }
    if (_tmp) {
...
function _M0FP212dongxuan20125cnnum17standard__integer(value, financial) {
  ...
  const high = BigInt.asUintN(64, BigInt.asIntN(64, value) / BigInt.asIntN(64, 100000000n));
  if (100000000n === 0n) {
    $panic();
  }
  ...
  const out = new _M0TPB8MutLocalGsE(`${_tmp}亿`);
  if (BigInt.asIntN(64, low) > BigInt.asIntN(64, 0n)) {
    ...
    const tail = new _M0TPB8MutLocalGsE(_tmp$2);
    const _tmp$3 = tail.val;
    const _bind$3 = "十";
    if (_M0MPC16string6String11has__prefix(_tmp$3, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length))) {
      tail.val = `一${tail.val}`;
    }
...
function _M0FP212dongxuan20125cnnum24format__currency_2einner(source, zero_yuan, yuan, whole_suffix, prefix, rounding, parentheses) {
  ...
  const value = new _M0TPB8MutLocalGlE(_tmp);
  const cents = `${f}00`;
  const tail = new _M0TPB8MutLocalGiE(((Math.imul((0 >>> 0 < cents.length ? cents.charCodeAt(0) : $oob()) - 48 | 0, 10) | 0) + (1 >>> 0 < cents.length ? cents.charCodeAt(1) : $oob()) | 0) - 48 | 0);
  if (rounding === "half-up" && (f.length > 2 && (2 >>> 0 < f.length ? f.charCodeAt(2) : $oob()) >= 53)) {
    tail.val = tail.val + 1 | 0;
  }
  if (tail.val === 100) {
  ...
  const out = new _M0TPB8MutLocalGsE(_tmp$2);
  if (tail.val === 0) {
    out.val = `${out.val}${whole_suffix}`;
  } else {
    if (10 === 0) {
      $panic();
    }
    if ((tail.val / 10 | 0) > 0) {
      ...
      out.val = `${_tmp$3}${_M0MPC15array5Array2atGRPB4JsonE(names, tail.val / 10 | 0)}角`;
    } else {
      if (BigInt.asIntN(64, value.val) > BigInt.asIntN(64, 0n)) {
        out.val = `${out.val}零`;
      }
    }
    if (10 === 0) {
...
function _M0FP212dongxuan20125cnnum22format__digits_2einner(source, financial) {
  ...
  while (true) {
    ...
    switch (c) {
      ...
      default: {
        _tmp = _M0MPC15array5Array2atGRPB4JsonE(names, c - 48 | 0);
      }
    }
...
function _M0FP212dongxuan20125cnnum13input__glyphs(source, relaxed) {
  ...
  if (!relaxed) {
    ...
    if (_M0MPC16string6String8contains(source, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
      ...
      let _tmp$3;
      const _bind$2 = "兩";
      if (_M0MPC16string6String8contains(source, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
        _tmp$3 = true;
      } else {
        const _bind$3 = "〇";
        _tmp$3 = _M0MPC16string6String8contains(source, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length));
      }
      _tmp$2 = _tmp$3;
    }
    _tmp = _tmp$2;
...
function _M0FP212dongxuan20125cnnum13an2cn_2einner(source, mode) {
  ...
  if (mode === "direct") {
    ...
    while (true) {
      ...
      if (c >= 48 && c <= 57) {
        _M0IPB13StringBuilderPB6Logger13write__string(out, _M0MPC15array5Array2atGRPB4JsonE(names, c - 48 | 0));
      } else {
        if (c === 45) {
          _M0IPB13StringBuilderPB6Logger13write__string(out, "负");
        } else {
          if (c === 46) {
  ...
  let clean;
  const _bind = ".";
  if (_M0MPC16string6String11has__suffix(text, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
    clean = _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(text, 0, text.length - 1 | 0));
  } else {
    clean = text;
  }
  if (mode === "rmb") {
  ...
  _L: {
    ...
    const _negative = _bind$3._0;
    const _whole = _bind$3._1;
    const _fraction = _bind$3._2;
    whole = _whole;
    negative = _negative;
    fraction = _fraction;
    break _L;
  ...
  const out = new _M0TPB8MutLocalGsE(`${_tmp}${_tmp$3}`);
  let f;
  _L$2: {
    _L$3: {
  ...
  if (_M0MPC16string6String8contains(_tmp, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
    while (true) {
      ...
      if (_M0MPC16string6String11has__suffix(_tmp$2, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
        out.val = _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(out.val, 0, out.val.length - 1 | 0));
        continue;
      } else {
        break;
      }
...
function _M0FP212dongxuan20125cnnum12short__group(source, relaxed, colloquial) {
  ...
  const pending = new _M0TPB8MutLocalGiE(-1);
  const previous = new _M0TPB8MutLocalGiE(10000);
  const zero = new _M0TPB8MutLocalGbE(false);
  const _bind = cs.length;
  let _tmp = 0;
  while (true) {
    const i = _tmp;
    if (i < _bind) {
  ...
  if (pending.val >= 0) {
    if (previous.val > 10 && (previous.val < 10000 && !zero.val)) {
      if (relaxed && colloquial) {
        const _tmp$2 = pending.val;
        if (10 === 0) {
          $panic();
        }
...
function _M0FP212dongxuan20125cnnum9below__yi(source, relaxed, colloquial) {
  ...
  if (!leading_zero) {
    const _bind$4 = "十";
    _tmp = _M0MPC16string6String11has__prefix(rest, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length));
  } else {
    _tmp = false;
  }
  if (_tmp) {
...
function _M0FP212dongxuan20125cnnum13unit__integer(source, relaxed) {
  ...
  if (!leading_zero) {
    let _tmp$2;
    const _bind$5 = "万";
    if (!_M0MPC16string6String8contains(rest, new _M0TPC16string10StringView(_bind$5, 0, _bind$5.length))) {
      _tmp$2 = !final_ellipsis;
    } else {
      _tmp$2 = false;
    }
    _tmp = _tmp$2;
...
function _M0FP212dongxuan20125cnnum13cn2an_2einner(source, mode) {
  ...
  let negative;
  const _bind = "负";
  if (_M0MPC16string6String11has__prefix(text, new _M0TPC16string10StringView(_bind, 0, _bind.length))) {
    negative = true;
  } else {
    let _tmp;
    if (mode === "smart") {
      const _bind$2 = "-";
      _tmp = _M0MPC16string6String11has__prefix(text, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length));
    } else {
      _tmp = false;
    }
    negative = _tmp;
  ...
  if (mode === "smart") {
    const _bind$2 = ".";
    _tmp = _M0MPC16string6String8contains(body, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length));
  } else {
    _tmp = false;
  }
  if (_tmp) {
    const cs = _M0MPC16string6String9to__array(body);
    const _bind$2 = _M0MPC15array5Array2atGcE(cs, cs.length - 1 | 0);
    let scale;
    switch (_bind$2) {
      case 21313: {
        scale = 1;
    ...
    _L: {
      ...
      const _whole = _bind$5._1;
      const _fraction = _bind$5._2;
      whole = _whole;
      fraction = _fraction;
      break _L;
    }
  ...
  const i = new _M0TPB8MutLocalGiE(0);
  const after_point = new _M0TPB8MutLocalGbE(false);
  while (true) {
    if (i.val < chars.length) {
      const c = _M0MPC15array5Array2atGcE(chars, i.val);
      if (c >= 48 && (c <= 57 && mode === "smart")) {
        const digits = _M0MPB13StringBuilder21StringBuilder_2einner(0);
        while (true) {
          if (i.val < chars.length && (_M0MPC15array5Array2atGcE(chars, i.val) >= 48 && _M0MPC15array5Array2atGcE(chars, i.val) <= 57)) {
            _M0IPB13StringBuilderPB6Logger11write__char(digits, _M0MPC15array5Array2atGcE(chars, i.val));
            i.val = i.val + 1 | 0;
            continue;
          } else {
            break;
        ...
        const run = _M0MPB13StringBuilder10to__string(digits);
        let _tmp$2;
        let _tmp$3;
        if (after_point.val) {
          _tmp$3 = true;
          ...
          if (run.length > 1) {
            const _bind$2 = "0";
            _tmp$4 = _M0MPC16string6String11has__prefix(run, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length));
          } else {
            _tmp$4 = false;
          }
          _tmp$3 = _tmp$4;
        ...
        _M0IPB13StringBuilderPB6Logger13write__string(expanded, _tmp$2);
      } else {
        if (c === 28857) {
          after_point.val = true;
        }
        _M0IPB13StringBuilderPB6Logger11write__char(expanded, c);
        i.val = i.val + 1 | 0;
      }
      continue;
    } else {
  ...
  const _tmp$2 = _M0MPB13StringBuilder10to__string(expanded);
  const _bind$2 = "点";
  ...
  const out = new _M0TPB8MutLocalGsE(`${negative ? "-" : ""}${_M0MPC15int645Int6418to__string_2einner(whole, 10)}`);
  if (parts.length === 2) {
    const fraction = _M0MPC16string10StringView9to__owned(_M0MPC15array5Array2atGRPB4JsonE(parts, 1));
    let _tmp$3;
    if (fraction.length > 64) {
      ...
      if (!relaxed) {
        ...
        if (_M0MPC16string6String9is__empty(fraction)) {
          ...
          const _bind$4 = "零";
          _tmp$5 = _M0MPC16string6String11has__suffix(fraction, new _M0TPC16string10StringView(_bind$4, 0, _bind$4.length));
        }
        _tmp$4 = _tmp$5;
      } else {
        _tmp$4 = false;
...
function _M0FP212dongxuan20125cnnum16conversion__span(text, start, chinese, direct) {
  ...
  const replacement = new _M0TPB8MutLocalGsE(first);
  const finish = new _M0TPB8MutLocalGiE(end);
  const kind = new _M0TPB8MutLocalGsE(direct ? "direct" : "number");
  if (!direct) {
    if (percent) {
            ...
            if (!chinese && (_M0FP212dongxuan20125cnnum8text__at(text, end, "%") || _M0FP212dongxuan20125cnnum8text__at(text, end, "％"))) {
              ...
              if (_M0FP212dongxuan20125cnnum8text__at(text, end, chinese ? "分之" : "/")) {
                ...
                if (second_end > second_start) {
                  ...
                  replacement.val = `${second}${chinese ? "/" : "分之"}${first}`;
                  finish.val = second_end;
                  kind.val = "fraction";
                }
              } else {
                let _tmp;
                  ...
                  if (_M0FP212dongxuan20125cnnum8text__at(text, end, "年")) {
                    ...
                    if (original.length >= 2) {
                      ...
                      if (original.length <= 4) {
                        let _tmp$5;
                        const _bind$2 = ".";
                        if (!_M0MPC16string6String8contains(original, new _M0TPC16string10StringView(_bind$2, 0, _bind$2.length))) {
                          const _bind$3 = "-";
                          _tmp$5 = !_M0MPC16string6String8contains(original, new _M0TPC16string10StringView(_bind$3, 0, _bind$3.length));
                        } else {
                          _tmp$5 = false;
                        }
                        _tmp$4 = _tmp$5;
                ...
                if (_tmp) {
                  ...
                  if (!chinese && (_M0FP212dongxuan20125cnnum8text__at(text, end, "-") && _M0FP212dongxuan20125cnnum16ascii__digit__at(text, end + 1 | 0))) {
                    ...
                    replacement.val = `${first}到${_tmp$2}`;
                    finish.val = second_end;
                    kind.val = "range";
                  }
                }
  ...
  while (true) {
    if (i.val < source.length) {
      ...
      _L$2: {
        ...
        _M0MPC15array5Array4pushGRPC14json10WriteFrameE(spans, span);
        i.val = span.end;
      }
      continue;
    } else {
...
function _M0FP212dongxuan20125cnnum17transform_2einner(source, direction, direct) {
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      const span = spans[_];
      _M0IPB13StringBuilderPB6Logger13write__string(out, _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(source, start.val, span.start)));
      _M0IPB13StringBuilderPB6Logger13write__string(out, span.replacement);
      start.val = span.end;
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0FP212dongxuan20125cnnum21parse__decimal__cents(s) {
  ...
  const _bind = "-";
  const neg = _M0MPC16string6String11has__prefix(s, new _M0TPC16string10StringView(_bind, 0, _bind.length));
  const whole = new _M0TPB8MutLocalGlE(0n);
  const fraction = new _M0TPB8MutLocalGlE(0n);
  const count = new _M0TPB8MutLocalGiE(0);
  const point = new _M0TPB8MutLocalGbE(false);
  const whole_digits = new _M0TPB8MutLocalGiE(0);
  const _bind$2 = neg ? 1 : 0;
...
function _M0FP412dongxuan20125cnnum3cmd3web13field__string(fields, name, fallback) {
  ...
  _L: {
    ...
    if (_bind === undefined) {
      return new _M0DTPC16result6ResultGsRPC15error5ErrorE2Ok(fallback);
    } else {
      const _Some = _bind;
      const _x = _Some;
      if (_x.$tag === 4) {
        ...
        return new _M0DTPC16result6ResultGsRPB7FailureE3Err(new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure(`${name} must be a string`));
      }
    }
  }
...
function _M0FP412dongxuan20125cnnum3cmd3web11field__bool(fields, name, fallback) {
  ...
  if (_bind === undefined) {
    ...
    switch (_x.$tag) {
      ...
      default: {
        return new _M0DTPC16result6ResultGbRPB7FailureE3Err(new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure(`${name} must be boolean`));
      }
    }
  }
}
function _M0FP412dongxuan20125cnnum3cmd3web13convert__json(request) {
  ...
  _L: {
    ...
    let fields;
    const _bind = _M0FPC14json13parse_2einner(new _M0TPC16string10StringView(request, 0, request.length), 1024);
    let _bind$2;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _bind$2 = _ok._0;
    ...
    switch (operation) {
      case "cn2an": {
        ...
        result = _M0MPC14json4Json6string(_tmp);
        break;
      }
      case "an2cn": {
        ...
        result = _M0MPC14json4Json6string(_tmp$2);
        break;
      }
      case "transform": {
        ...
        result = _M0MPC14json4Json6string(_tmp$3);
        break;
      }
      case "spans": {
      ...
      case "currency": {
        ...
        result = _M0MPC14json4Json6string(_tmp$16);
        break;
      }
      default: {
        _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("unknown operation");
        break _L;
      }
    }
    const _bind$19 = [{ _0: "ok", _1: _M0MPC14json4Json7boolean(true) }, { _0: "result", _1: result }];
    return _M0MPC14json4Json17stringify_2einner(_M0MPC14json4Json6object(_M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$19, 0, 2), undefined)), false, 0, undefined);
  }
  const e = _try_err;
  ...
  _L: {
    ...
    _L$2: {
      _L$3: {
        let values;
        _L$4: {
          const _bind$4 = _M0MPB3Map3getGsRPB4JsonE(fields, "inputs");
        ...
        const _bind$4 = _M0MPC15array5Array3mapGRPB4JsonsEHRPB7Failure(values, (value) => {
          let s;
          _L$5: {
            if (value.$tag === 4) {
              const _String = value;
              ...
              return new _M0DTPC16result6ResultGsRPB7FailureE3Err(new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("string input required"));
            }
          }
          return new _M0DTPC16result6ResultGsRPB7FailureE2Ok(s);
        });
        if (_bind$4.$tag === 1) {
          const _ok = _bind$4;
          inputs = _ok._0;
      ...
      _try_err = new _M0DTPC15error5Error48moonbitlang_2fcore_2fbuiltin_2eFailure_2eFailure("inputs required");
      break _L;
    }
    let iterations;
    let value;
    _L$3: {
      _L$4: {
        const _bind$4 = _M0MPB3Map3getGsRPB4JsonE(fields, "iterations");
        if (_bind$4 === undefined) {
          iterations = 0;
        } else {
          const _Some = _bind$4;
      ...
      iterations = _M0MPC16double6Double7to__int(value);
    }
    if (iterations < 1 || (iterations > 10000 || (inputs.length < 1 || inputs.length > 64))) {
      ...
      if (_ < iterations) {
        ...
        while (true) {
          ...
          if (_$2 < _bind$5) {
            ...
            length.val = _tmp$3 + _tmp$4.length | 0;
            _tmp$2 = _$2 + 1 | 0;
            continue;
          } else {
            break;
    ...
    const _bind$6 = [{ _0: "ok", _1: _M0MPC14json4Json7boolean(true) }, { _0: "elapsedMs", _1: _M0IPC16double6DoublePB6ToJson8to__json(elapsed) }, { _0: "length", _1: _M0IPC13int3IntPB6ToJson8to__json(length.val) }, { _0: "results", _1: _M0IPC15array5ArrayPB6ToJson8to__jsonGsE(results) }];
    return _M0MPC14json4Json17stringify_2einner(_M0MPC14json4Json6object(_M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$6, 0, 4), undefined)), false, 0, undefined);
  }
  const e = _try_err;
  const _bind = [{ _0: "ok", _1: _M0MPC14json4Json7boolean(false) }, { _0: "error", _1: _M0IPC16string6StringPB6ToJson8to__json(_M0IP016_24default__implPB4Show10to__stringGRPC15debug4ReprE(_M0MPC15debug4Repr4ReprGRPC15error5ErrorE(e))) }];
  return _M0MPC14json4Json17stringify_2einner(_M0MPC14json4Json6object(_M0MPB3Map3MapGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 2), undefined)), false, 0, undefined);
