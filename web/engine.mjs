...
_M0DTPC15error5Error43localreview_2fcnnum_2eNumberError_2eInvalid.prototype.$tag = 0;
  ...
  while (true) {
    ...
    if (i < _bind$2) {
      ...
      if (d === 0) {
        ...
        result.val = `${result.val}${_M0MPC15array5Array2atGsE(names, d)}${_M0MPC15array5Array2atGsE(units, 3 - i | 0)}`;
      }
      _tmp = i + 1 | 0;
      continue;
    } else {
...
function _M0FP211localreview5cnnum23format__integer_2einner(n, financial) {
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      const _tmp$2 = _M0MPC15array5Array2atGsE(powers, i);
      if (_tmp$2 === 0n) {
        $panic();
      }
      if (10000n === 0n) {
      ...
      if (part === 0) {
        ...
        out.val = `${out.val}${_M0FP211localreview5cnnum5group(part, financial)}${_M0MPC15array5Array2atGsE(units, i)}`;
        skipped.val = false;
      }
      _tmp = i + 1 | 0;
      continue;
...
function _M0FP211localreview5cnnum13format__money(cents) {
  ...
  if (jiao > 0) {
    out.val = `${out.val}${_M0MPC15array5Array2atGsE(names, jiao)}角`;
  } else {
  ...
  if (fen > 0) {
    out.val = `${out.val}${_M0MPC15array5Array2atGsE(names, fen)}分`;
  }
